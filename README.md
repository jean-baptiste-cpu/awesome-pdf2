...
- [PixelTools](https://pixeltools.io/) - Free browser-based PDF toolkit — merge, split, compress, convert, rotate, and watermark. 100% client-side via WebAssembly, no signup.
